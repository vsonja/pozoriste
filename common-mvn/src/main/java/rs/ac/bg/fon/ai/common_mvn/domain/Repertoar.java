...
/**
 * Predstavlja mesecni repertoar pozorista.
 * Repertoar ima repertoarID, mesec, godinu i listu stavki repertoara.
 * 
...
public class Repertoar extends OpstiDomenskiObjekat implements Serializable {
     ...
     * 
     * Svi njegovi atributi (repertoarID, mesec, godina i stavke) ostaju neinicijalizovani.
     */
    public Repertoar() {
    }

    /**
     * Pravi novi repertoar i postavlja jedinstveni identifikator repertoara, mesec, godinu i stavke na unete vrednosti.
     * 
     ...
     * @param stavke Stavke repertoara kao lista objekata klase StavkaRepertoara.
     */
